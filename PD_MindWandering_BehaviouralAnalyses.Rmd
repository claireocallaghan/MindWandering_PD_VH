...
plot1 <- ggbarplot(df, x = "Group", y = "MW.frequency", 
          color = "Group", add = c("mean_se","dotplot"), palette =c("#E7B800","#00AFBB", "#FC4E07","#FC4E07"), add.params = list(dotsize = 0.6), position = position_dodge(0.3)) + ylab("% Mind Wandering") + scale_x_discrete(name="")+
...
plot2 <- ggbarplot(df_levels_melted_raw, x = "Level", y = "Response", 
          color = "Group", add = c("mean_se","dotplot"), palette =c("#E7B800","#00AFBB", "#FC4E07","#FC4E07"), add.params = list(dotsize = 0.5), position = position_dodge(0.9), width = 0.82) + ylab("% Response") +
theme(legend.title=element_blank())+
theme(axis.title.x = element_text(size=15),
axis.title.y = element_text(size=15))+
